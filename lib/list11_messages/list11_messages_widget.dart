...
class List11MessagesWidget extends StatefulWidget {
  const List11MessagesWidget({Key? key}) : super(key: key);

  @override
  _List11MessagesWidgetState createState() => _List11MessagesWidgetState();
}
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    StreamBuilder<List<TextDataRecord>>(
                      stream: queryTextDataRecord(
                        queryBuilder: (textDataRecord) => textDataRecord.where(
                          'fraud_threat',
                          isEqualTo: true,
                        ),
                      ),
                      builder: (context, snapshot) {
                        ...
                        List<TextDataRecord> listViewTextDataRecordList =
                            snapshot.data!;
                        return ListView.builder(
                          padding: EdgeInsets.zero,
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          itemCount: listViewTextDataRecordList.length,
                          itemBuilder: (context, listViewIndex) {
                            final listViewTextDataRecord =
                                listViewTextDataRecordList[listViewIndex];
                            return Padding(
